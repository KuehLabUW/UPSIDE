...
See UPSIDE Software User Guide.docx for instruction of how to use the software. Image data is available for download separately at https://idr.openmicroscopy.org/about/experiments.html (work in progress)
