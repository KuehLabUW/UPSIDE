...
import numpy as np
import sys
from AML211Dataset_Mask import AML211Dataset_Mask
...
for step in range(total_step):
    ...
    if (step+1) % 1000 == 0:
        ...
        torch.save(Q.state_dict(),weights_path + 'Q_VAE_AML211__large_LIVE_100z_nodropout_Mask_{}.pt'.format(step+1)) 
        torch.save(P.state_dict(),weights_path + 'P_VAE_AML211__large_LIVE_100z_nodropout_Mask_{}.pt'.format(step+1))
