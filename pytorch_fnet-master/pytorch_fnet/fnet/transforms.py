...
class Resizer(object):
    def __init__(self, factors):
        ...
        #self.factors = factors #original code
        self.factors = (factors[0],factors[1]) #SN to fix the "sequence argument must have length equal to input rank" error
        #print(self.factors) #SN
