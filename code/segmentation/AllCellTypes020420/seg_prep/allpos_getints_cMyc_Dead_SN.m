...
for p = 143:278    % loop over all the stage positions
...
for t = 1:T    % loop through all timepoints
    ...
    obj = [];
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    for p = 143:278   % loop through all stage positions
...
gatenames = {'ALL'};
save([dirname 'segtracksint_cMyc111617RatioDead2.mat'],'objects','gatenames');
