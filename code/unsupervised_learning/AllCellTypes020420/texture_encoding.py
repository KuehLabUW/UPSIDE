...
#%%
#################
with open(output_path + 'style_CellTypes020420_VAE_TextureChosen.csv', mode='w') as data:
        data_writer = csv.writer(data, delimiter=',')
        data_writer.writerows(total_z)
with open(output_path + 'root_CellTypes020420_VAE_TextureChosen.csv', mode='w') as data:
        data_writer = csv.writer(data, delimiter=',')
