...
code_dir = '/media/phnguyen/Data2/Imaging/UPSIDEv1/code/CellTypes020420/unsupervised_learning/';
% enter the directory for the csv file containing barcode information
root_dir = '/media/phnguyen/Data2/Imaging/UPSIDEv1/data/CellTypes020420/csvs/';
