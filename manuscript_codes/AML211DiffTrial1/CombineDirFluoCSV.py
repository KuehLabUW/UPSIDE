...
csvs_dirname = '/media/phnguyen/Data2/Imaging/CellMorph/data/AML211DiffTrial1/csvs/'
...
for i in range(0,pos_num):
    fluoCSVname = 'fluoAML211Trial1pos{}.csv'.format(i+1)
    dirCSVname  = 'SubImTextureAML211DiffTrial1pos{}.csv'.format(i+1)
