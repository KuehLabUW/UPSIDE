...
csvfilenamePI = 'CombinedSubstractedDirFluoDeadPI.csv';
cd(code_dir)
...
T = table(dirname,pos,t,cell,live,dead,div);
T_PI = readtable(strcat(root_dirPI,csvfilenamePI),'Delimiter', ',', 'HeaderLines', 0, 'ReadVariableNames', true, 'Format', '%s %f %f %f %f %f %f');
