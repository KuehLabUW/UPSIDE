...
combined_csvname = 'CombinedDirUMAP_VAE_LargeMask_Watershed_Subgate_fluo.csv';
#combined_csvname = 'CombinedSubstractedDirUMAP_GANdis.csv';


dirCSVname  = 'AML211_ALLLargeMaskSubstractedWatershedDirFluo.csv'
UMAPCSVname = 'CombinedDirUMAP_VAE_LargeMask_Watershed_Subgate.csv'
