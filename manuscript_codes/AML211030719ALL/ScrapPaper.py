...
combined_csvname = 'CombinedDirUMAP_VAE_LargeMask_FLUO_subgate2.csv';
#combined_csvname = 'CombinedSubstractedDirUMAP_GANdis.csv';


dirCSVname  = 'AML211_VAE_LargeMask_subgate_truncatedZ.csv'
UMAPCSVname = 'CombinedDirUMAP_VAE_LargeMask_FLUO_subgate.csv'
