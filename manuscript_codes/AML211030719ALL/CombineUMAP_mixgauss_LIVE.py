...
combined_csvname = 'CombinedSubstractedDirUMAP_largeLIVE60z_nodropout_mask.csv';
#combined_csvname = 'CombinedSubstractedDirUMAP_GANdis.csv';


dirCSVname  = 'test_LIVE_truncated.csv'
UMAPCSVname = 'AML211_umap_mixgauss_largeLIVE_nodropout_mask.csv'
