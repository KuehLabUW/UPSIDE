...
combined_csvname_drug = 'AnnoSemiCombinedSubstractedDirFluoUMAPdrug_onehot_large2.csv';
combined_csvname_nondrug = 'AnnoSemiCombinedSubstractedDirFluoUMAPnondrug_onehot_large2.csv';

dirCSVname  = 'AML211_ALLSubstractedDirFluotruncated.csv'
UMAPCSVname = 'SemiAML211_umap_onehotSubstracted_largeAnno2.csv'
#make utils function
