...
Nondrug_filename = 'CombinedLargeMaskSubstractedWatershedDir.csv'
Drug_filename = 'CombinedLargeMaskSubstractedWatershedDrugDir.csv'
MegredDrugNondrug_filename = 'AML211_ALLLargeMaskSubstractedWatershedDir.csv'
