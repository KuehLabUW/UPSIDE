...
Nondrug_filename = 'CombinedLargeMaskSubstractedDir.csv'
Drug_filename = 'CombinedLargeMaskSubstractedDrugDir.csv'
MegredDrugNondrug_filename = 'AML211_ALLLargeMaskSubstractedDir.csv'
