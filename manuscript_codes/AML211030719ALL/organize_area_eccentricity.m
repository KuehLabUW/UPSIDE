...
datadirfile = 'CombinedSubstractedDirUMAP_LargeMaskSubstractedWatershed.csv';

datamatrix = readtable(strcat(root_dir,datadirfile),'Delimiter', ',', 'HeaderLines', 0, 'ReadVariableNames', true, 'Format', '%s %f %f %f %f %f %f %f %s');
area =[];
eccentricity = [];
im_size = 64;
...
writetable(newmatrix,[root_dir 'CombinedSubstractedDirUMAP_Area_LargeMaskSubstractedWatershed.csv']);
scatter(newmatrix.area,newmatrix.eccentricity,10,categorical(datamatrix.style))
