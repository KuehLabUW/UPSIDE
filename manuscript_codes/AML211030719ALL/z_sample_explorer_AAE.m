...
latent_var_name = 'style_CombinedSubstractedDirUMAP_mixgaus_largeLIVEFLUO60z_nodropout_Mask.csv';
...
plot(1:1:60,z_std_sorted)
hold on
scatter(1:1:60,z_std_sorted)
%choose the first 41 elements with the largest std
idx_element_matter = Index(1:15);
...
csvwrite(strcat(root_dir,'latent_z_60_AAE_mixgauss_scan_mask.csv'),synbarcode)
