...
Nondrug_filename = 'CombinedLargeMaskSubstractedDirFluo.csv'
Drug_filename = 'CombinedLargeMaskSubstractedDrugDirFluo.csv'
MegredDrugNondrug_filename = 'AML211_ALLLargeMaskSubstractedDirFluo.csv'
