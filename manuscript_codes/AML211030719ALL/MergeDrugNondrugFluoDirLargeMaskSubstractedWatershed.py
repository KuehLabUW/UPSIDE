...
Nondrug_filename = 'CombinedLargeMaskSubstractedWatershedDirFluo.csv'
Drug_filename = 'CombinedLargeMaskSubstractedWatershedDrugDirFluo.csv'
MegredDrugNondrug_filename = 'AML211_ALLLargeMaskSubstractedWatershedDirFluo.csv'
