...
gatefilename = 'LIVEgates_VAE_LiveMask_subgateWatershed.mat';
...
T = table(dirname);
writetable(T,'/media/phnguyen/Data2/Imaging/CellMorph/data/AML211030719ALL/csvs/AML211_test_LIVE_LargeMaskWatershed_Subgate.csv')
