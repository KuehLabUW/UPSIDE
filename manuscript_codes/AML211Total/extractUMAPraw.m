...
umapfilename = 'CombinedDirUMAP.csv';
...
matrix = readtable(strcat(root_dir,umapfilename),'Delimiter', ',', 'HeaderLines', 0, 'ReadVariableNames', true, 'Format', '%s %f %f %f %f %f %f %f');
...
acq.C(2).tlist = tlist;
save('/media/phnguyen/Data2/Imaging/CellMorph/data/AML211Total/mat/acqMask.mat','acq')

%%%%%%%%%%%%% get data you want
%% get UM and nonUM compound samples

objects = bundle_mat_forcyto2(matrix,7,8); %bundle the table into a .mat format for visualization

save('/media/phnguyen/Data2/Imaging/CellMorph/data/AML211Total/mat/objects_T.mat','objects')
