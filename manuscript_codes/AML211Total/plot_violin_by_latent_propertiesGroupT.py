...
prop_name = 'APC_corr'; # 'APC_corr','PE_corr','distance'
# enter the list of features
#flist = ['m47','m80','m77','m17','m5','all','m85','m19','m24','m61','m46'];
#flist = ['m69','m15','m19','m26','all','m38','m45','m99','m51'];
flist = ['all','T1','T2','T3']
...
if prop_name == 'distance':
    ...
    df = pd.read_csv('/media/phnguyen/Data2/Imaging/CellMorph/data/AML211DiffALL/csvs/Dataset1CompleteAreaEdgeFluoClusterGroupT.csv')
    df = df[df['trial']!=2]
