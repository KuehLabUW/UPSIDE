...
combined_csvname = 'Dataset3Complete.csv';
#combined_csvname = 'CombinedSubstractedDirUMAP_GANdis.csv';


dirCSVname  = 'LIVE_total.csv'
UMAPCSVname = 'CombinedUMAPDirGroupDataset3.csv'
#UMAPCSVname = 'AML211_umap_GANdis_largeLIVE.csv'
#make utils function
def merge_dir_fluo_df(df_1,df_2):

    #merge the two together to match IDs
    merge_df = pd.merge(df_1,df_2,on=['pos', 't','cell','trial','dataset'],how = 'inner')
