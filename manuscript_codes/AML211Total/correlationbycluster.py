...
for i in np.unique(df_updated.cluster):
    subdf = df_updated[df_updated.cluster == i and (df_updated.trial == trial) ]
...
plt.savefig("/home/phnguyen/Desktop/violinPE.svg")
plt.show()
...
sns.violinplot(x='cluster', y=prop, data=df_updated, order=ordered_idx)
plt.savefig("/home/phnguyen/Desktop/violinAPC.svg")
plt.show()
