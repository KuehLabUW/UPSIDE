...
datadirfile = 'LIVE_tracked.csv';

datamatrix = readtable(strcat(root_dir,datadirfile),'Delimiter', ',', 'HeaderLines', 0, 'ReadVariableNames', true, 'Format', '%s %f %f %f %f %f %f %f %f %f');
area =[];
eccentricity = [];
im_size = 64;
...
writetable(newmatrix,[root_dir 'LIVE_tracked_Area.csv']);
