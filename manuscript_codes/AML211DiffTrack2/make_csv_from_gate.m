...
clear
root_dir = '/media/phnguyen/Data2/Imaging/CellMorph/data/AML211DiffTrack2/mat/';
gatefilename = 'gates.mat';
...
T = table(dirname);
writetable(T,'/media/phnguyen/Data2/Imaging/CellMorph/data/AML211DiffTrack2/csvs/LIVE_subgate.csv')
