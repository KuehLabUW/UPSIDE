...
matfile = '/media/phnguyen/Data2/Imaging/CellMorph/data/AML211DiffALL/mat/ClusterScan.mat';
datacolumn = 217;
Text = ['%s'];
for i = 1:datacolumn
    Text = [Text ' %f'];
...
datamatrix_short = datamatrix(:,[1:12,213:218]);
load(matfile)
...
for c = 1:numel(Cluster)
    ...
    writematrix(Gmember,sprintf('/media/phnguyen/Data2/Imaging/CellMorph/data/AML211DiffALL/csvs/ClusterScan/Clustermemberset%d.csv',c))
    %continue
    ...
    writetable(datamatrix_short,sprintf('/media/phnguyen/Data2/Imaging/CellMorph/data/AML211DiffALL/csvs/ClusterScan/datamatrixGroupT%d.csv',c))
    %keyboard
end
%%
