...
matrix = readtable(strcat(root_dir,umapfilename),'Delimiter', ',', 'HeaderLines', 0, 'ReadVariableNames', true, 'Format', '%s %f %f %f %f %f %f %f %f %f %f %f %f');
...
acq.C(2).tlist = tlist;
save('/media/phnguyen/Data2/Imaging/CellMorph/data/AML211DiffTrack/mat/acqMask.mat','acq')
...
save('/media/phnguyen/Data2/Imaging/CellMorph/data/AML211DiffTrack/mat/objects_T.mat','objects')
