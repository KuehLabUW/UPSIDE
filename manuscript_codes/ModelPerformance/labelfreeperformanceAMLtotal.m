...
%%
datadir = '/media/phnguyen/Data2/pytorch_fnet-master/pytorch_fnet/results/3d/AllCellTypesCellTracetrain/test_og/';
predictim_tiffname = 'prediction_AllCellTypesCellTracetrain.tiff';
