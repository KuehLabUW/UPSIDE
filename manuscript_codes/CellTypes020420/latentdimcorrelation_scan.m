...
chosenL = 40;
z_texture_std = std(table2array(datamatrix(:,115:115+99)),1);
[z_texture_std_sorted, IndexT] = sort(z_texture_std,'descend');


z_mask_std = std(table2array(datamatrix(:,15:15+99)),1);
...
datamatrix_mask = datamatrix(:,15:114);
datamatrix_texture = datamatrix(:,115:214);
...
%%
save('/media/phnguyen/Data2/Imaging/CellMorph/data/CellTypes020420/mat/ClusterScan.mat','Cluster')