...
csvfilename = 'ChosenCells_Area.csv';

datamatrix = readtable(strcat(root_dir,csvfilename),'Delimiter', ',', 'HeaderLines', 0, 'ReadVariableNames', true, 'Format', '%f %s %f %f %f %f %f %f %f %f %f');
sharpvalue =[];
im_size = 64;
...
writetable(newmatrix,[root_dir 'ChosenCells_Area_Sharp.csv']);
