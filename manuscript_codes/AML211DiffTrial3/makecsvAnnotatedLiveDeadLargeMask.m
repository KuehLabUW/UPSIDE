...
annotated_name = '/media/phnguyen/Data2/Imaging/CellMorph/data/AML211030719ALL/csvs/AML211_LargeMask_Annotated.csv'; %this is from old AML211data
csvfilenameLargeMask =  'CombinedLargeMaskSubstractedWatershedDir.csv';
cd(code_dir)


matrix = readtable(annotated_name,'Delimiter', ',', 'HeaderLines', 0, 'ReadVariableNames', true, 'Format', '%s %f %f %f %f %f');

matrix_LargeMask = readtable(strcat(root_dir,csvfilenameLargeMask),'Delimiter', ',', 'HeaderLines', 0, 'ReadVariableNames', true, 'Format', '%f %s %f %f %f %f %f');
...
new_annotated_table_name = 'AllCellTypes_LargeMask_Annotated_Nopadding.csv';
