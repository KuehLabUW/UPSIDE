...
combined_csvname = 'CombinedSubstractedDirUMAP_LargeMaskSubstrectedWatershed.csv';
#combined_csvname = 'CombinedSubstractedDirUMAP_GANdis.csv';


dirCSVname  = 'test_LIVE_LargeMask.csv'
UMAPCSVname = 'AllCellsTypes_umap_VAE_LargeMaskWatershed.csv'
