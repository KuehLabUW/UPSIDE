...
umapfilename = 'CombinedSubstractedDirUMAP_LargeMaskSubstractedWatershed.csv';
cd(code_dir)


%read bulk csv file

matrix = readtable(strcat(root_dir,umapfilename),'Delimiter', ',', 'HeaderLines', 0, 'ReadVariableNames', true, 'Format', '%s %f %f %f %f %f %f %f %s');
...
acq.C(2).tlist = tlist;
save('/media/phnguyen/Data2/Imaging/CellMorph/data/CellTypesShapes/mat/acqLiveLargeMask.mat','acq')

%%%%%%%%%%%%% get data you want
%% get UM and nonUM compound samples

objects = bundle_mat_forcyto2_celltype(matrix,7,8,9); %bundle the table into a .mat format for visualization

save('/media/phnguyen/Data2/Imaging/CellMorph/data/CellTypesShapes/mat/object_ALL_Live_VAE_LargeMask_Watershed_Subgate.mat','objects')
