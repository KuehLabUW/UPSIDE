...
csvs_dirname = '/media/phnguyen/Data2/Imaging/CellMorph/data/AML211DiffTrial3/csvs/'
...
for i in range(0,pos_num):
    fluoCSVname = 'fluoAML211Trial3pos{}.csv'.format(i+1)
    dirCSVname  = 'SubImTextureAML211DiffTrial3pos{}.csv'.format(i+1)
