...
combined_csvname = 'LiveDeadValidated.csv';
#combined_csvname = 'CombinedSubstractedDirUMAP_GANdis.csv';


dirCSVname  = 'livedead.csv'
UMAPCSVname = 'CombinedMaskDirFluo_livedead.csv'
#UMAPCSVname = 'AML211_umap_GANdis_largeLIVE.csv'
#make utils function
def merge_dir_fluo_df(df_1,df_2):

    #merge the two together to match IDs
    merge_df = pd.merge(df_1,df_2,on=['dirname','pos', 't','cell'],how = 'inner')
