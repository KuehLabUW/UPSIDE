...
RFPoffset = 2000;
P = 350;
dirname = '/data/kueh/061217 - Bcl11b-YFP-RFP-CFP Exp3 ANALYZED/';

for p = 1:P    % loop over all the stage positions
   pos(p) = load([dirname 'pos ' num2str(p) '/segtrack.mat']);  % load all the objects
end
...
gatenames = {'ALL'};
save([dirname 'segtracksint_ALL060717.mat'],'objects','gatenames');
