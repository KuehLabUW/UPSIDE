function [seg] = cellseg080518ML(im)
...
minsize = 400%250;   % minimum size of a cell was 400
maxsize = 10000 %2000;  % maximum size of a cell
maxecc = 3%2;    % the maximum eccentricity of a cell was 3
maxratio = 28; % the maximum perimeter squared/area of a cell 
% maxwobble = 0.03; % the maximum variation in cell perimeter% was 28
