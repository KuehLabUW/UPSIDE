...
for p =1
    for t = 1:10
       ...
       filename = '/media/phnguyen/Data2/pytorch_fnet-master/pytorch_fnet/results/3d/CellTypeCellTraceTrain112319v2/testCellTypes020420/0%d';
       filename = sprintf(filename,dirname(i));
       display(dirname(i))
       cd(filename)
       signal = imread('signal.tiff');
       %Enter the name of your predictive images here
       predict = imread('prediction_CellTypeCellTraceTrain112319v2.tiff');
       ...
       predict_name = 'EXP2_w2Camera CellTrace_s%d_t%d.TIF';
...
for p = 1
    for t = 11
       i = i + 1; %file name count  
       filename = '/media/phnguyen/Data2/pytorch_fnet-master/pytorch_fnet/results/3d/CellTypeCellTraceTrain112319v2/testCellTypes020420/%d';
       filename = sprintf(filename,dirname(i));
       display(dirname(i))
       cd(filename)
       signal = imread('signal.tiff');
